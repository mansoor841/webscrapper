...
using webscrapper.plugins.hallmark.tasks.eod_report.shared;

namespace webscrapper.plugins.hallmark.tasks.eod_report;

public class EodReportTask : BaseAdapterTask
{
    public override string TaskName => "hallmark.eod_report_task";
