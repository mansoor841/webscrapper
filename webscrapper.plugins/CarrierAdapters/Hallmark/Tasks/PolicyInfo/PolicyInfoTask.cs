...
using webscrapper.plugins.hallmark.tasks.policy_info.shared;

namespace webscrapper.plugins.hallmark.tasks.policy_info;

public class PolicyInfoTask : BaseAdapterTask
{
    public override string TaskName => "hallmark.policy_info_task";
